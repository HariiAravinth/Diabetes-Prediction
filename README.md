...
o	PyTorch / TabNet/  Rtdl
Development and experimentation were conducted using Google Collab.
...
•	Imputation of missing clinical measurements, Faircut imputation was used for a more effective and realistic imputation
•	SMOTE was performed to avoid Bias 
...
Ft transformer model was also implemented though not specifically designed for Categorical use cases, it proved to be effective. Revealing that advanced deep learning models pave a way for more interpretable and reliable predictive models in a wide range of scenarios.
...
This approach supports responsible deployment of machine learning in healthcare.
Interpretability tools such as SHAP and Lime were used for each model how the models arrived at the decision. While applying SHAP and Lime for Tabular Transformers a clear correlation between its feature attribution mechanism and SHAP results was visible. Though a advanced deep learning model it has proven to be explainable.
...
<img width="451" height="699" alt="image" src="https://github.com/user-attachments/assets/ce177f00-488a-496a-ad15-12b0063ab21b" />
